...
class AlleleSegment(object):
    ...
    def __init__(self, allele_segment_line):
        ...
        chrom, start, end, ascat_alleles, controlfreec_alleles, accucopy_alleles = allele_segment_line.rstrip().split('\t')
        self.chrom = chrom
        self.start  = start
        self.end = end
        ...
        self.na_count = (ascat_alleles, controlfreec_alleles, accucopy_alleles).count('.')
...
header = ("chrom", "start", "end",
          ...
          "ascat_alleles", "controlfreec_alleles", "accucopy_alleles")
    ...
    for line in merged_allele_file:
        ...
        if allele_obj.na_count == 2:
            ...
            single_caller_allele_tuple = (allele_obj.chrom, allele_obj.start, allele_obj.end,
                                          ...
                                          allele_obj.ascat_alleles, allele_obj.controlfreec_alleles, allele_obj.accucopy_alleles)
