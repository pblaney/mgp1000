...
echo "#SBATCH --job-name=slurmsub.${pipelineStep}.${runId}.%j" >> "${submissionScript}"
echo "#SBATCH --output=slurmsub.${pipelineStep}.${runId}.%j.txt" >> "${submissionScript}"
echo "#SBATCH --error=slurmsub.${pipelineStep}.${runId}.%j.err" >> "${submissionScript}"
